...
using Reqnroll;
namespace AutomationFrameworkRepo_v03.Features.UserInterface
{
    ...
    [NUnit.Framework.DescriptionAttribute("UI Form Validation")]
    [NUnit.Framework.FixtureLifeCycleAttribute(NUnit.Framework.LifeCycle.InstancePerTestCase)]
    public partial class UIFormValidationFeature
    {
